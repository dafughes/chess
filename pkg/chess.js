...
export class Game {
    ...
    */
    piece_at(square) {
        const ret = wasm.game_piece_at(this.__wbg_ptr, square);
        return ret;
    }
    /**
    * @param {Move} mv
    */
    make_move(mv) {
        ...
        wasm.game_make_move(this.__wbg_ptr, mv.__wbg_ptr);
    }
    /**
    * @returns {(Move)[]}
    */
    legal_moves() {
        try {
            ...
            wasm.game_legal_moves(retptr, this.__wbg_ptr);
...
export class Move {
    ...
    */
    set from(arg0) {
        wasm.__wbg_set_move_from(this.__wbg_ptr, arg0);
    }
    /**
    * @returns {number}
    */
    ...
    */
    set to(arg0) {
        wasm.__wbg_set_move_to(this.__wbg_ptr, arg0);
    }
    /**
    * @returns {number}
    */
    get promotion_type() {
        const ret = wasm.__wbg_get_move_promotion_type(this.__wbg_ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set promotion_type(arg0) {
        wasm.__wbg_set_move_promotion_type(this.__wbg_ptr, arg0);
    }
    /**
    * @param {number} from
    * @param {number} to
    ...
    */
    constructor(from, to, promotion_type) {
        const ret = wasm.move_new(from, to, promotion_type);
        this.__wbg_ptr = ret >>> 0;
